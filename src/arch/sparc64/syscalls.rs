...
lazy_static! {
    pub static ref DEFINITIONS: HashMap<Sysno, Vec<Argument>> = HashMap::from([
        ...
        (
            ...
            vec![
                Argument {
                    ty: "utrap_entry_t".to_string(),
                    name: "type".to_string(),
                },
                Argument {
                    ty: "utrap_handler_t".to_string(),
                    name: "new_p".to_string(),
                },
                Argument {
                    ty: "utrap_handler_t".to_string(),
                    name: "new_d".to_string(),
                },
                Argument {
                    ty: "utrap_handler_t __user *".to_string(),
                    name: "old_p".to_string(),
                },
                Argument {
                    ty: "utrap_handler_t __user *".to_string(),
                    name: "old_d".to_string(),
                },
            ]
        ),
        (
