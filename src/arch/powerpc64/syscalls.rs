...
lazy_static! {
    pub static ref DEFINITIONS: HashMap<Sysno, Vec<Argument>> = HashMap::from([
        ...
        (
            ...
            vec![
                Argument {
                    ty: "struct oldold_utsname __user *".to_string(),
                    name: "name".to_string(),
                },
            ]
        ),
        ...
        (
            ...
            vec![
                Argument {
                    ty: "struct ucontext __user *".to_string(),
                    name: "old_ctx".to_string(),
                },
                Argument {
                    ty: "struct ucontext __user *".to_string(),
                    name: "new_ctx".to_string(),
                },
                Argument {
                    ty: "long".to_string(),
        ...
        (
            ...
            vec![
                Argument {
                    ty: "struct rtas_args __user *".to_string(),
                    name: "uargs".to_string(),
                },
            ]
        ),
        ...
        (
            ...
            vec![
                ...
                Argument {
                    ty: "__u32 __user *".to_string(),
                    name: "unpc".to_string(),
                },
                Argument {
                    ty: "__u32 __user *".to_string(),
                    name: "ustatus".to_string(),
                },
            ]
        ),
        (
